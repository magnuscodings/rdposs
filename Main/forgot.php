                            ...
                            <div class="card text-center login-card">
                                <div class="card-body">
                                    <div class="mb-5">
                                        ...
                                        <h1 class="login-heading">RECOVER ACCOUNT</h1> <!-- Corrected spelling of "CONFIRM" -->
                                    </div>


                                    <div class="mb-3">
                                        <label style='float:left;'>Enter your email : <b></b></label>
                                    ...
                                    <div class="d-grid gap-2 col-2 mx-auto mb-3">
                                        <button class="btn btn-success" type="submit" name="btnForgot">SEND</button> 
                                    </div>
