                            ...
                            <div class="card text-center login-card">
                                <div class="card-body">
                                    <div class="mb-5">
                                        ...
                                        <h1 class="login-heading">CREATE NEW PASSWORD</h1> <!-- Corrected spelling of "CONFIRM" -->
                                    </div>


                                    <div class="mb-3">
                                        <label style='float:left;'>New Password</label>
                                        <input type="password" class="form-control" placeholder="Password" value='' name="newpsw">
                                        <span class="error"><?php echo $newpswErr?></span>
                                        <br>
                                        <label style='float:left;'>Cunfirm Password</label>
                                        <input type="password" class="form-control" placeholder="Cunfirm Password" value='' name="cunfirm_newpsw">
                                        <span class="error"><?php echo $cunfirm_newpswErr?></span>
                                    </div>
                                
                                    <div class="d-grid gap-2 col-12 mx-auto mb-3">
                                        <button class="btn btn-success" type="submit" name="btnNewPassword">UPDATE PASSWORD</button> 
                                    </div>
