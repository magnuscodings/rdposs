            ...
            <div class="col-10">
                <div class="container-fluid d-flex justify-content-center mb-2">
                    <div class="card w-100">             
                        <div class="card-body">
                          <h5 class="card-title" style="text-align: center;">SYSTEM LOG REPORT</h5>
                          <div class="container">
                            <div class="table-responsive">
                                <table id="example"  class="table">
                                    ...
                                    <tbody>
                                    <?php  
                                    $view_query = mysqli_query($connections,"SELECT * from system_log"); 
                                    $item_numer=0;
                                    while($row = mysqli_fetch_assoc($view_query)){ //<-- ginagamit tuwing kukuha ng database
                                     
                                            $db_sys_id = $row["sys_id"];
                                            $db_sys_user_id = $row["sys_user_id"];
                                            $db_sys_login = $row["sys_login"];
                                            $db_sys_logout = $row["sys_logout"];
                                         
                                        
                                            
                                            $get_recordUnit = mysqli_query ($connections,"SELECT * FROM account where acc_id ='$db_sys_user_id' ");
...
window.location.href = "addstocks.php";
                                    ...
                                    <td><?php echo  date("M j Y, g:ia", strtotime($db_sys_login)) ?></td>
                                    <td><?php echo  $db_sys_logout?>                
                                    </td>
