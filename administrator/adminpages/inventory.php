            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" >Item Inventory</h1>
                                    ...
                                    while($row = mysqli_fetch_assoc($view_query)){ 
                                           ...
                                           $s_expiration = $row["s_expiration"];
                                            ...
                                            if($db_prod_stocks<=$db_critical_level){
                                                ...
                                                if($db_prod_stocks==null){
                                                  $level="<b style='color:red;'>Out of stocks</b>";
        ...
        <div class="col-md-4 mb-2">
            ...
            <script>
                function updateProduct(prodId) {
                    window.location.href = "edit_inventory.php?item_code=" + prodId;
                }
            </script>
        </div>
        ...
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="prod_name" value="<?php echo $prod_name ?>" placeholder="Item Name">
                        <span class='error'><?php echo $prod_nameErr; ?></span>
                    </div>
                    <div class="mb-3">
                       <label >original price</label>
                        <input type="text" class="form-control" name="prod_orgprice" value="<?php echo $prod_orgprice ?>" placeholder="Original Price">
                        <span class='error'><?php echo $prod_orgpriceErr; ?></span>
                    </div>
                    <div class="mb-3">
                        <label >current price</label>
                        <input type="text" class="form-control" name="prod_currprice" value="<?php echo $prod_currprice ?>" placeholder="Current Price">
                        ...
                        <div class="dropdown">
                            <select class="btn btn-secondary dropdown-toggle btn-sm" name="prod_unit">
                                ...
                                while ($row = mysqli_fetch_assoc($view_query)) {
                                    ...
                                    $db_unit_name = $row["unit_name"];
                                    $selected = ($prod_unit == $db_unit_id) ? "selected" : "";
                                ?>
                                    <option value="<?php echo $db_unit_id ?>" class="dropdown-item" <?php echo $selected ?>><?php echo $db_unit_name ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="dropdown">
                            <select class="btn btn-secondary dropdown-toggle btn-sm" name="prod_category">
                                ...
                                while ($row = mysqli_fetch_assoc($view_query)) {
                                    ...
                                    $db_category_name = $row["category_name"];
                                    $selected = ($prod_category == $db_category_id) ? "selected" : "";
                                ?>
                                    <option value="<?php echo $db_category_id ?>" class="dropdown-item" <?php echo $selected ?>><?php echo $db_category_name ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="mb-3">
                        <textarea name="prod_description" class="form-control" rows="3" placeholder="Enter description"></textarea>

                    </div>
                    <div class="mb-3">
                        <input type="file" name="prod_image" class="btn btn-outline-secondary col-12">Attach image
                        <br><?php echo $prod_image; ?>
                    </div>
                    <div class="container d-flex justify-content-center">
                        <button type="submit" name='btnAddProduct' class="btn btn-primary btn-sm">ADD ITEM</button>
