      ...
      <tr>
        ...
        <td>
          <div class="container text-center">
            ...
            <div class="container">
              <button type="button" class="btn btn-danger canceltoogle" data-bs-toggle="modal" data-bs-target="#exampleModal1" data-transaction="<?= $ret_transaction_code ?>">
                Cancel
              </button>
            </div>
          </div>
      ...
      <tr>
        ...
        <td>
          <div class="container text-center">
            ...
            <div class="container">
              <button type="button" class="btn btn-danger canceltoogle" data-bs-toggle="modal" data-bs-target="#exampleModal1" data-transaction="<?= $ret_ol_transaction_code ?>">
                Cancel
              </button>
            </div>
          </div>
